...
func NewAnteHandler(ak AccountKeeper, fck FeeCollectionKeeper) sdk.AnteHandler {
	return func (
        ...
        if ok {
            ...
            _, res := ProcessPubKey(signerAccs[0], stdSigs[0], simulate) // fkey something
...
>>>>>>> cc81a45163bd7de64aaac0b2dfd0a10929359e01
                    if !res.IsOK() {
                        return newCtx, res, true
                    }
...
=======
                    acc0.SubKeys[stdSigs[0].PubKeyIndex - 1].DailyFeeUsed.Add(stdTx.Fee.Amount)
>>>>>>> c7ea7b7aae4ce482619b504e4b9b9735b5d838e0
